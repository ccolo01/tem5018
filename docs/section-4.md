# Section 4: Programmable Microcontrollers — Real-World Problem Solving
...
## 4.1 Introduction: Making the Invisible Visible
...
## 4.2 Understanding Microcontrollers
...
## 4.3 Microcontrollers for Primary Education
...
The **[BBC micro:bit](https://microbit.org/)** is the most widely used microcontroller in UK primary education. Originally developed by the BBC and partners (including Microsoft, ARM, and Lancaster University) and distributed free to Year 7 students across the UK in 2016, the micro:bit is now managed by the Micro:bit Educational Foundation and used in over 60 countries.
...
- Low cost (approximately £15-20 per unit)

### 4.3.2 Crumble Controller
...
- Very affordable (approximately £12 for controller only)
...
## 4.4 Block-Based Programming with MakeCode
...
## 4.5 The Crumble Programming Environment
...
## 4.6 Age-Appropriate Progression
...
## 4.7 Cross-Curricular Connections
...
- **Teach Computing Curriculum**: [https://teachcomputing.org/](https://teachcomputing.org/) — includes physical computing units
...
**Preparation for Session 5**: Before the next session, complete at least one micro:bit or Crumble project. Reflect on: What did children find challenging? What connections did they make to other subjects? How did working with physical hardware change the learning experience compared to screen-only programming?
